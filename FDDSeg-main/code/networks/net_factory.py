...
from networks.unet import UNet, UNet_DS, UNet_CCT, UNet_CCT_3H, UNet_CCT1, UNet_CCT2
...
def net_factory(net_type="unet", in_chns=1, class_num=3):
    ...
    elif net_type == "unet_cct2":
        net = UNet_CCT2(in_chns=in_chns, class_num=class_num).cuda()
